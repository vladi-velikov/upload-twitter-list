...
Twitter.prototype.listGet= function (params, error, success) {
    var path = '/lists/list.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};
Twitter.prototype.listCreate = function (params, error, success) {
    var path = '/lists/create.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};
Twitter.prototype.listAddMembers = function (params, error, success) {
    var path = '/lists/members/create_all.json';
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};
Twitter.prototype.listRemoveMembers = function (params, error, success) {
